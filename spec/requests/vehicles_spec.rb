...
RSpec.describe "/vehicles", type: :request do
  ...
  let(:valid_attributes) {
    { name: "Splendor", type: "TwoWheeler"}
  }

  let(:invalid_attributes) {
    { name: nil, type: "TwoWheeler"}
  }
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Vehicle" do
        expect {
          post vehicles_url, params: { two_wheeler: valid_attributes }
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested vehicle" do
        vehicle = Vehicle.create! valid_attributes
        patch vehicle_url(vehicle), params: { two_wheeler: new_attributes }
        vehicle.reload
        expect(vehicle.name).to eq(new_attributes[:name])
      end
    ...
    context "with invalid parameters" do
      ...
      it "renders a response with 422 status (i.e. to display the 'edit' template)" do
        vehicle = Vehicle.create! valid_attributes
        patch vehicle_url(vehicle), params: { two_wheeler: invalid_attributes }
        expect(response).to have_http_status(:unprocessable_entity)
      end
